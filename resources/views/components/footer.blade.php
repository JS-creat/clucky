    ...
    <div class="max-w-6xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 gap-8 sm:gap-10">
        ...
        <div class="w-full">
            ...
            <div class="space-y-2 text-sm">
                ...
                <p>
                    <a href="https://maps.google.com/?q=Jr.+Bolognesi+908+Concepcion+Peru" target="_blank"
        ...
        <div class="w-full">
            ...
            <div class="space-y-2 text-xs sm:text-sm">
                <p><a href="{{ route('quienes-somos') }}"
                        class="text-gray-400 hover:text-white transition-colors duration-200">Quiénes somos</a></p>
