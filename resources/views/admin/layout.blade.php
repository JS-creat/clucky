        ...
        <aside :class="open ? 'w-64' : 'w-24'"
            ...
            <nav class="flex-1 p-4 space-y-2 mt-4">
                ...
                <div x-data="{ otrosOpen: {{ $otrosActive ? 'true' : 'false' }} }">
                    <button @click="otrosOpen = !otrosOpen" class="w-full flex items-center gap-4 p-4 rounded-2xl font-semibold transition-all group
                    ...
                    <div x-show="otrosOpen && open" x-transition:enter="transition ease-out duration-200"
                        ...
                        <a href="{{ route('admin.movimientos.index') }}"
                            class="flex items-center gap-3 px-4 py-3 rounded-xl font-semibold transition-all group
   {{ request()->routeIs('admin.movimientos.index') ? 'bg-white/10 text-white' : 'text-gray-500 hover:bg-white/10 hover:text-white' }}">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <button type="submit"
                        ...
                        <x-heroicon-o-arrow-left-on-rectangle
                            class="w-6 h-6 group-hover:-translate-x-1 transition-transform flex-shrink-0" />
