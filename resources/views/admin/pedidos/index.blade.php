    ...
    <div class="space-y-8 px-2 md:px-0">
        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
                ...
                <p class="text-gray-500 mt-1 text-base md:text-lg font-medium">Gestiona y supervisa el flujo de ventas de tu
                    tienda.</p>
                <div
                    class="mt-3 inline-flex items-center gap-2 px-4 py-1.5 bg-indigo-50 text-indigo-700 rounded-full text-xs font-black uppercase tracking-wider">
        ...
        <div class="hidden md:block overflow-x-auto">
            <div class="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 overflow-hidden min-w-[1000px]"></div>
            <table class="w-full border-collapse">
                <thead>
                    <tr class="bg-gray-50/50 border-b border-gray-50">
                        <th class="px-8 py-6 text-left text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">N°
                            Pedido</th>
                ...
                <tbody class="divide-y divide-gray-50">
                    @forelse($pedidos as $pedido)
                        ...
                        <tr class="group hover:bg-indigo-50/30 transition-all duration-300">
                            ...
                            <td class="px-8 py-8">
                                <span
                                    class="text-lg font-black text-gray-900 group-hover:text-indigo-600 transition-colors tracking-tight">
                            ...
                            <td class="px-8 py-8 text-center">
                                <span
                                    class="inline-block text-lg font-black text-gray-900 bg-gray-50 px-5 py-2 rounded-2xl border border-gray-100 shadow-inner">
                            ...
                            <td class="px-8 py-8 text-center">
                                <span
                                    class="inline-block px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest border {{ $color }} shadow-sm">
